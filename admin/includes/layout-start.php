...
$navItems = [
    ...
    'mgmt' => 'Management',
    ['users', '/admin/pages/users/users-list.php', 'Users'],
    ['sellers', '/admin/pages/sellers/sellers-list.php', 'Sellers'],
    ['products', '/admin/pages/products/products-list.php', 'Products'],
    ['categories', '/admin/pages/categories/categories-list.php', 'Categories'],
    ['orders', '/admin/pages/orders/orders-list.php', 'Orders'],
    ['coupons', '/admin/pages/coupons/coupons-list.php', 'Coupons'],
    'analytics' => 'Analytics',
    ['reports', '/admin/pages/reports/sales-report.php', 'Reports'],
    ['audit', '/admin/pages/audit/audit-log.php', 'Audit log'],
    'settings' => 'Settings',
    ['site', '/admin/pages/settings/site-settings.php', 'Site settings'],
];
?><!DOCTYPE html>
...
<div id="app">
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
      <form action="/admin/actions/logout.php" method="post" style="margin:0;">
        <button type="submit" class="btn btn-outline w-100">Logout</button>
      </form>
    </div>
  </aside>
    ...
    <header class="header">
      ...
      <div class="header-right" style="display:flex;align-items:center;gap:12px;">
        ...
        <div class="user-profile">
          <div class="user-avatar"><?= e(strtoupper(mb_substr(preg_replace('/\s+/', '', (string) ($user['name'] ?? 'A')) ?: 'A', 0, 2))) ?></div>
          <div class="user-info">
