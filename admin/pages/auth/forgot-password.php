...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect('/admin/pages/auth/forgot-password.php?sent=1');
}
...
<?php else: ?>
  <form method="post" action="/admin/pages/auth/forgot-password.php">
    <div class="form-group">
      <label class="form-label" for="email"><?= e(t('auth.email')) ?></label>
      <input type="email" class="form-control" id="email" name="email" required autofocus placeholder="admin@multivendor.com">
    </div>
