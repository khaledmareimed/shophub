...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($password) < 8) {
        ...
        redirect('/seller/pages/auth/reset-password.php?token=' . urlencode($token));
    }
    if ($password !== $confirm) {
    ...
    if (!$ok) {
        ...
        redirect('/seller/pages/auth/forgot-password.php');
    }
...
<?php else: ?>
  <form method="post" action="/seller/pages/auth/reset-password.php">
